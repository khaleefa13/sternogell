...
<body class="text-slate-800 antialiased bg-[#D5DEEF] flex flex-col min-h-screen selection:bg-blue-600 selection:text-white">
    ...
    <header class="relative bg-[#D5DEEF] text-slate-900 py-16 md:py-32 mt-14 md:mt-16 text-center overflow-hidden">
        ...
        <div class="relative z-10 px-4 max-w-5xl mx-auto flex flex-col items-center">
            <span class="text-blue-600 font-bold tracking-[0.2em] text-[10px] md:text-sm mb-3 md:mb-4 uppercase border border-blue-200 px-4 py-1.5 rounded-full bg-blue-50/80 inline-block">LINI BISNIS UTAMA</span>
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mt-4 md:mt-6 mb-3 md:mb-4">
                KATEGORI <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-slate-700">PRODUK</span>
            </h1>
    ...
    <main class="flex-grow max-w-7xl mx-auto px-5 lg:px-8 py-12 md:py-20 w-full relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            ...
            <div class="group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:border-blue-200 transition-all duration-300 overflow-hidden cursor-pointer flex flex-col" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
                <div class="h-40 md:h-64 overflow-hidden relative bg-slate-50 p-4 flex items-center justify-center">
                    <div class="absolute top-3 right-3 md:top-4 md:right-4 bg-blue-700 text-white text-[10px] md:text-xs font-bold px-2.5 py-1 rounded-full z-10 shadow-lg">190G</div>
            ...
            <div class="group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:border-blue-200 transition-all duration-300 overflow-hidden cursor-pointer flex flex-col" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
                <div class="h-40 md:h-64 overflow-hidden relative bg-slate-50 p-4 flex items-center justify-center">
                    <div class="absolute top-3 right-3 md:top-4 md:right-4 bg-blue-700 text-white text-[10px] md:text-xs font-bold px-2.5 py-1 rounded-full z-10 shadow-lg">250G</div>
            ...
            <div class="group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:border-blue-200 transition-all duration-300 overflow-hidden cursor-pointer flex flex-col" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
                <div class="h-40 md:h-64 overflow-hidden relative bg-slate-50 p-4 flex items-center justify-center">
                    <div class="absolute top-3 right-3 md:top-4 md:right-4 bg-slate-800 text-white text-[10px] md:text-xs font-bold px-2.5 py-1 rounded-full z-10 shadow-lg">400G MAX</div>
        ...
        <div class="mt-12 md:mt-20 bg-white border border-slate-200 rounded-3xl p-6 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col md:flex-row justify-between items-center relative overflow-hidden">
            <div class="absolute -right-10 -top-10 w-32 h-32 md:w-40 md:h-40 bg-blue-100 rounded-full blur-3xl opacity-50"></div>
