...
<body class="text-gray-800 antialiased bg-gray-50 flex flex-col min-h-screen selection:bg-red-700 selection:text-white">
    ...
    <header class="relative bg-black text-white py-16 md:py-32 mt-14 md:mt-16 text-center overflow-hidden">
        ...
        <div class="relative z-10 px-4">
            <span class="text-red-600 font-bold tracking-[0.2em] text-[10px] md:text-sm mb-3 md:mb-4 uppercase border border-red-600/30 px-3 md:px-4 py-1.5 rounded-full bg-red-600/10 inline-block">LINI BISNIS UTAMA</span>
            ...
            <p class="text-gray-400 max-w-2xl mx-auto text-xs md:text-base font-light px-2">Eksplorasi rangkaian produk Sterno Gel berkualitas tinggi yang dirancang khusus untuk efisiensi energi industri dan komersial.</p>
        </div>
    </header>
    ...
    <main class="flex-grow max-w-7xl mx-auto px-5 lg:px-8 py-12 md:py-20 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            ...
            <div class="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer flex flex-col" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
                ...
                <div class="p-6 md:p-8 flex-grow flex flex-col justify-center items-center text-center">
                    ...
                    <p class="text-xs md:text-sm font-light text-gray-500 mb-5 md:mb-6 line-clamp-2">Solusi energi panas presisi untuk kebutuhan katering standar dengan durasi bakar optimal.</p>
                    <a href="#" class="inline-flex items-center justify-center text-[10px] md:text-xs font-bold bg-white text-black border-2 border-black px-5 py-2.5 md:px-6 md:py-3 rounded-full hover:bg-black hover:text-white transition-colors duration-300 shadow-md w-full sm:w-auto">
            ...
            <div class="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer flex flex-col" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
                ...
                <div class="p-6 md:p-8 flex-grow flex flex-col justify-center items-center text-center">
                    <h3 class="text-xl md:text-2xl font-extrabold text-black mb-2 tracking-tight">STERNO GEL 250</h3>
                    <p class="text-xs md:text-sm font-light text-gray-500 mb-5 md:mb-6 line-clamp-2">Formula tahan lama untuk lingkungan yang lebih menuntut dan pemanasan ekstra.</p>
                    <a href="#" class="inline-flex items-center justify-center text-[10px] md:text-xs font-bold bg-white text-black border-2 border-black px-5 py-2.5 md:px-6 md:py-3 rounded-full hover:bg-black hover:text-white transition-colors duration-300 shadow-md w-full sm:w-auto">
                        LIHAT DETAIL <i class="fa-solid fa-arrow-right ml-2"></i>
                    </a>
                </div>
            ...
            <div class="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer flex flex-col" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
                <div class="h-40 md:h-64 overflow-hidden relative bg-gray-100 p-4 flex items-center justify-center">
                    <div class="absolute top-3 right-3 md:top-4 md:right-4 bg-black text-white text-[10px] md:text-xs font-bold px-2.5 py-1 rounded-full z-10 shadow-lg">400G MAX</div>
                ...
                <div class="p-6 md:p-8 flex-grow flex flex-col justify-center items-center text-center">
                    <h3 class="text-xl md:text-2xl font-extrabold text-black mb-2 tracking-tight">STERNO GEL 400 MAX</h3>
                    <p class="text-xs md:text-sm font-light text-gray-500 mb-5 md:mb-6 line-clamp-2">Output panas maksimal untuk kebutuhan industri dan prasmanan skala besar.</p>
                    <a href="#" class="inline-flex items-center justify-center text-[10px] md:text-xs font-bold bg-white text-black border-2 border-black px-5 py-2.5 md:px-6 md:py-3 rounded-full hover:bg-black hover:text-white transition-colors duration-300 shadow-md w-full sm:w-auto">
                        LIHAT DETAIL <i class="fa-solid fa-arrow-right ml-2"></i>
                    </a>
                </div>
            ...
            <div class="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer flex flex-col" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
                <div class="h-40 md:h-64 overflow-hidden relative bg-gray-100 p-4 flex items-center justify-center">
                    <div class="absolute top-3 right-3 md:top-4 md:right-4 bg-gray-200 text-black text-[10px] md:text-xs font-bold px-2.5 py-1 rounded-full z-10 shadow-lg">REFILL</div>
                ...
                <div class="p-6 md:p-8 flex-grow flex flex-col justify-center items-center text-center">
                    <h3 class="text-xl md:text-2xl font-extrabold text-black mb-2 tracking-tight">BULK / REFILL</h3>
                    <p class="text-xs md:text-sm font-light text-gray-500 mb-5 md:mb-6 line-clamp-2">Pilihan hemat dalam kemasan bulk untuk efisiensi operasional bisnis jangka panjang.</p>
                    <a href="#" class="inline-flex items-center justify-center text-[10px] md:text-xs font-bold bg-white text-black border-2 border-black px-5 py-2.5 md:px-6 md:py-3 rounded-full hover:bg-black hover:text-white transition-colors duration-300 shadow-md w-full sm:w-auto">
                        LIHAT DETAIL <i class="fa-solid fa-arrow-right ml-2"></i>
                    </a>
                </div>
        ...
        <div class="mt-12 md:mt-20 bg-black rounded-3xl p-6 md:p-12 shadow-2xl flex flex-col md:flex-row justify-between items-center relative overflow-hidden">
            <div class="absolute -right-10 -top-10 w-32 h-32 md:w-40 md:h-40 bg-red-700 rounded-full blur-3xl opacity-50"></div>
            <div class="text-center md:text-left mb-6 md:mb-0 relative z-10">
                <h4 class="text-xl md:text-3xl font-extrabold text-white mb-2">Butuh spesifikasi khusus?</h4>
                <p class="text-xs md:text-base text-gray-400 font-light">Tim kami siap membantu kebutuhan industri Anda dalam skala besar.</p>
            </div>
            <a href="/contact" class="relative z-10 bg-red-700 text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-full hover:bg-red-600 transition-colors shadow-[0_0_20px_rgba(185,28,28,0.4)] hover:shadow-[0_0_25px_rgba(185,28,28,0.6)] whitespace-nowrap text-xs md:text-base">
